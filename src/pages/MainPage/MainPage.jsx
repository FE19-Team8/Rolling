...
const MainPage = () => {
  ...
  return (
    <main className="mx-auto flex w-full max-w-[1200px] flex-col items-center px-3 py-[30px] md:px-6 md:py-[60px] xl:px-0 xl:py-[60px]">
      ...
      <section className="bg-surface mb-[48px] flex h-auto w-full max-w-[1200px] flex-col-reverse items-start justify-start gap-[40px] rounded-[16px] p-[6px] md:p-[40px] xl:h-[324px] xl:flex-row xl:gap-0 xl:p-[60px_192px_60px_0]">
      ...
      <div className="flex w-full items-center justify-center">
        <Button size="medium" className="w-full xl:w-[280px]" onClick={() => navigate('/list')}>
          구경해보기
        </Button>
      </div>
    </main>
